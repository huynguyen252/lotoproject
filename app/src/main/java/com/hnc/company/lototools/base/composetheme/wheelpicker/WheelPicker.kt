...
fun FVerticalWheelPicker(
    ...
    display: @Composable FWheelPickerDisplayScope.(
        index: Int
    ) -> Unit = { DefaultWheelPickerDisplay(it) },
...
private class WheelPickerNestedScrollConnection(private val state: FWheelPickerState,) :
...
private class FWheelPickerDisplayScopeImpl(override val state: FWheelPickerState,) :
